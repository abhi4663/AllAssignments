...
var questionRoutes_1 = require("./src/routes/questionRoutes");
var answerRouter_1 = require("./src/routes/answerRouter");
...
function connectToDatabase() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    connstr = "mongodb+srv://" + process.env.DB_USER + ":" + process.env.DB_PASSWORD + "@mern.js49d.mongodb.net/" + process.env.DB_NAME + "?retryWrites=true&w=majority";
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                app.use("/api/question", questionRoutes_1.questionRouter);
                app.use("/api/user", userRoutes_1.userRouter);
                app.use("/api/answer", answerRouter_1.answerRouter);
                return [2 /*return*/];
        }
    });
}); };
