...
exports.getAnswersByQuestion = exports.addNewanswer = void 0;
...
var addNewanswer = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var answers, a1, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                answers = new answerSchema_1.default({
...
var getAnswersByQuestion = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var answers, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, answerSchema_1.default.find({ questionId: req.params.questionId })];
            case 1:
                answers = _a.sent();
            ...
            case 2:
                err_2 = _a.sent();
                res.status(400).send("Error " + err_2);
                return [3 /*break*/, 3];
